...
Feature selection to remove unnecessary columns
...
Distribution analysis of bike prices

Relationship between price and year, kilometers driven, and owner type
...
The dataset was split into training and testing sets, and models were evaluated using metrics like:
...
Feature importance analysis showed that bike age, kilometers driven, and brand significantly impact resale price

The model can predict realistic price ranges for used bikes
